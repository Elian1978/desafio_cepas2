class WinesController < ApplicationController
  ...
  def new
    ...
    @strains.each do
      #Crear nuevas instancias para formulario anidado con build, recibe el wine.id
  ...
  private
    ...
    def authorize_admin
      #unless current_user.present? && current_user.admin? es lo mismo que la linea de abajo
      if user_signed_in?
